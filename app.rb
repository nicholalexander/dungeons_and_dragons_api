...
class DungeonsAndDragonsAPI < Roda
  ...
  plugin :sessions,
    key: '_DungeonsAndDragonsAPI.session',
    #cookie_options: {secure: ENV['RACK_ENV'] != 'test'}, # Uncomment if only allowing https:// access
    secret: ENV.send((ENV['RACK_ENV'] == 'development' ? :[] : :delete), 'DUNGEONS_AND_DRAGONS_API_SESSION_SECRET')
