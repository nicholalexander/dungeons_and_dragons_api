...
Unreloader = Rack::Unreloader.new(subclasses: %w'Roda Sequel::Model', logger: logger, reload: dev){DungeonsAndDragonsAPI}
require_relative 'models'
Unreloader.require('app.rb'){'DungeonsAndDragonsAPI'}
run(dev ? Unreloader : DungeonsAndDragonsAPI.freeze.app)
